    ...
    return(
        <main className='container jd-profile-page'>
            ...
            <ul className='jd-infos'>
                ...
                <li className='li-jd-infos text-center'>URL repositories : <a href='https://api.github.com/users/github-john-doe/repos' className='url-repos text-primary'>{user.repos_url}</a></li>
            </ul>
        </main>
    )
}