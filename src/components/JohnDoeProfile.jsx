...
export default function JohnDoeProfile() {
    ...
    return(
        <main className='jd-profile-page'>
            <section className='presentation-jdpp'>
                <h1 className='h1-jdpp fs-2'>Github user</h1>
                <h2 className='h2-jdpp fs-4'>{user.name}</h2>
                <img className='pdp-jd' src={PhotoDeProfilJohnDoe} alt="dessin de type cartoon représentant un chat bleu." />
            </section>
            <ul className='jd-infos'>
                <li className='li-jd-infos'>{user.bio}</li>
                ...
                <li className='li-jd-infos'>URL repositories : <a href='https://api.github.com/users/github-john-doe/repos' className='url-repos text-primary'>{user.repos_url}</a></li>
            </ul>
        </main>
    )
}