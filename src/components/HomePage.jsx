                    ...
                    <div className="card-body">
                        <div className="row">
                            <section className="col-md-6">
                                ...
                                <p className="card-text texte-a-propos">Basé à Lyon, je suis en recherche d'une alternance au sein d'une agence digitale
                                    pour consolider ma formation de <strong>développeur web full stack</strong>.
                                </p>
                                <p className="card-text texte-a-propos">J'accorde une attention particulière à la qualité du code que j'écris et je 
                            ...
                            <section className="col-md-6">
                                ...
                                <h4 className="card-text titres competences mb-1">Mes compétences</h4>
